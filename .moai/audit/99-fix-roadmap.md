...
**Laatst bijgewerkt:** 2026-04-22 — SEC-021 runtime-api socat bridge LIVE op dev, end-to-end bot spawn geverifieerd via Playwright, RLS-gap in meetings.py gefixed, AUTH-008-G sweep 24 post-commit `db.refresh()` op category-D RLS tables.
**Input documenten:**
