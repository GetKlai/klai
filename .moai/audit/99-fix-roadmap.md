...
| ~~**IN_PROGRESS**~~ | SEC-018 | Monorepo-wide Dockerfile USER audit | F-029 | knowledge-ingest, bge-m3-sparse, caddy (doc) | **✅ Dockerfiles gepatcht lokaal** — knowledge-ingest + bge-m3-sparse draaien nu als `app` (uid 1000). caddy intentional-root gedocumenteerd (privileged-port binding). Commit pending. |
