...
- Backend model: `klai-portal/backend/app/models/knowledge_bases.py`
- Backend API: `klai-portal/backend/app/api/app_knowledge_bases.py`
- Access service: `klai-portal/backend/app/services/access.py` (`get_accessible_kb_slugs`)
- Frontend KB detail: `klai-portal/frontend/src/routes/app/knowledge/$kbSlug.tsx`
- Frontend KB list: `klai-portal/frontend/src/routes/app/knowledge/index.tsx`
- Frontend KB new: `klai-portal/frontend/src/routes/app/knowledge/new.tsx`
- Frontend docs: `klai-portal/frontend/src/routes/app/docs/index.tsx`
