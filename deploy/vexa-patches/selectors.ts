...
// IMPORTANT: text="X" = exact match; text=X (no quotes) = partial/contains match.
// text*="X" is CSS attribute syntax — does NOT match text content.
export const googleRemovalIndicators: string[] = [
  // Meeting ended — Google Meet shows "This call has ended" (use contains match)
  'text=call has ended',
  'text=meeting has ended',
  'text=This call has ended',
  'text=This meeting has ended',

  // Rejoin button appears immediately after meeting ends (most reliable signal)
