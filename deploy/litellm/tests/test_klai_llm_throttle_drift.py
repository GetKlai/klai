"""Detect drift between LiteLLM-vendored and canonical klai_llm_throttle."""
...
_CANONICAL_DIR = _REPO_ROOT / "klai-libs" / "llm-throttle" / "klai_llm_throttle"
_VENDORED_DIR = _REPO_ROOT / "deploy" / "litellm" / "klai_llm_throttle"
...
def test_litellm_vendored_llm_throttle_matches_canonical() -> None:
