    ...
    <Popover onOpenChange={(open) => {
      ...
      <PopoverTrigger asChild>
        <button
          ...
          className="relative inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-gray-500 outline-none transition-colors klai-hover hover:text-gray-900 focus-visible:ring-2 focus-visible:ring-[var(--color-rl-accent)]"
        >
