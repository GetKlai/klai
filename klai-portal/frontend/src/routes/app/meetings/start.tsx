  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pt-4 pb-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-start gap-3 rounded-md border border-gray-200 bg-[var(--color-secondary)] p-4">
          <input
            id="consent"
            type="checkbox"
            checked={consentGiven}
            onChange={(e) => setConsentGiven(e.target.checked)}
            className="mt-1 h-4 w-4 shrink-0 rounded border-gray-200 accent-[var(--color-rl-accent)]"
          />
          <label
            htmlFor="consent"
