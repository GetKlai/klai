...
export const adminUsersMessages = {
  ...
  // SPEC-PORTAL-PRICING-PER-USER-001 Phase 2 — seat selector mocks.
  admin_users_field_seat: () => 'Seat',
  admin_users_col_seat: () => 'Seat',
  admin_users_seat_viewer_label: () => 'Viewer',
  admin_users_seat_chat_label: () => 'Klai Chat',
  admin_users_seat_knowledge_label: () => 'Klai Chat + Knowledge',
  admin_users_seat_free: () => 'Free',
  admin_users_seat_price_per_month: ({ amount }: { amount: number }) => `€${amount}/mo`,
  admin_users_seat_suggested: () => 'Suggested',
  admin_users_seat_mismatch_warning: () => 'Role requires KB management; chosen seat does not unlock it.',
