...
export const adminUsersMessages = {
  ...
  admin_users_offboard_wizard_personal_only_description: () => 'Offboard personal only',
  admin_users_delete_wizard_personal_only_description: () => 'Delete personal only',
  admin_users_offboard_wizard_no_owned_data_description: () => 'Offboard no owned data',
  admin_users_delete_wizard_no_owned_data_description: () => 'Delete no owned data',
  admin_users_wizard_loading: () => 'Preparing...',
  admin_users_wizard_preview_error: ({ error }: { error: string }) => `Preview failed: ${error}`,
  admin_users_wizard_step_impact: () => 'Impact',
  admin_users_wizard_step_kbs: () => 'Knowledge bases',
  admin_users_wizard_step_transfer: () => 'Transfer',
  admin_users_wizard_step_confirm: () => 'Confirm',
  admin_users_wizard_next: () => 'Next',
  admin_users_wizard_back: () => 'Back',
  admin_users_wizard_impact_title: () => 'What will be affected',
  admin_users_wizard_team_kbs_label: () => 'Team KBs',
  admin_users_wizard_personal_kbs_label: () => 'Personal KBs',
  admin_users_wizard_tokens_label: () => 'Tokens',
  ...
  admin_users_wizard_transfer_kbs: ({ count }: { count: number }) => `Transfer team KBs (${count})`,
  admin_users_wizard_personal_kbs: ({ count }: { count: number }) => `Personal KBs (${count})`,
  admin_users_wizard_action_label: () => 'Action',
  admin_users_wizard_transfer: () => 'Transfer',
  admin_users_wizard_transfer_to: () => 'to',
  admin_users_wizard_recipient_label: () => 'Transfer to',
  admin_users_wizard_no_transfer: () => 'Will be deleted.',
  admin_users_wizard_personal_delete_hint: () => 'Personal KBs are deleted',
  admin_users_wizard_will_be_deleted: () => 'Will be deleted',
  admin_users_wizard_confirm_title: () => 'Summary',
  admin_users_wizard_summary_transfer: () => 'Team KBs to transfer',
  admin_users_wizard_summary_team_delete: () => 'Team KBs to delete',
  admin_users_wizard_summary_personal_delete: () => 'Personal KBs to delete',
  admin_users_wizard_no_related_data: () => 'No related data.',
  admin_users_delete_wizard_final_warning: () => 'User will be deleted.',
  admin_users_offboard_wizard_final_warning: () => 'User will be offboarded.',
