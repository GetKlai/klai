...
export function BillingFreeCard() {
  return (
    <Card>
      <CardContent className="py-12 flex flex-col items-center text-center gap-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-400 max-w-sm">{m.admin_billing_free_description()}</p>
        </div>
...
export function BillingMandateRequestedCard() {
  return (
    <Card>
      <CardContent className="py-12 flex flex-col items-center text-center gap-4">
        <div className="rounded-full bg-[var(--color-rl-accent)]/10 p-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-400 max-w-sm">{m.admin_billing_mandate_description()}</p>
        </div>
...
export function BillingPaymentFailedCard({ onRetry }: { onRetry: () => void }) {
  return (
    <Card>
      <CardContent className="py-12 flex flex-col items-center text-center gap-4">
...
export function BillingCancelledCard({ onReactivate }: { onReactivate: () => void }) {
  return (
    <Card>
      <CardContent className="py-12 flex flex-col items-center text-center gap-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-400 max-w-sm">{m.admin_billing_cancelled_description()}</p>
        </div>
