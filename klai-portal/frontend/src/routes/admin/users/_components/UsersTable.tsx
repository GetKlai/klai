...
const userListGrid =
  'lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.7fr)_minmax(0,0.9fr)_minmax(0,0.6fr)_minmax(88px,0.6fr)_144px]'
  ...
  return (
    <ListFrame data-help-id="admin-users-table">
      <ListHeader className={`hidden gap-x-3 ${userListGrid} lg:grid`}>
        ...
        <span className="justify-self-stretch text-right">{m.admin_users_col_actions()}</span>
      </ListHeader>
