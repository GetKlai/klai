...
#   DOMAIN             — getklai.com
#
# See: claude-docs/pitfalls/platform.md#platform-portal-api-deploy-env-preflight
...
reason = (
    ...
    '  3. See: claude-docs/pitfalls/platform.md#platform-portal-api-deploy-env-preflight\n'
)
